                    ...
                    <div class="w-25">
                        <form action="{{route('admin.fertilizer.index')}}" method="get">
                            <div class="d-flex flex-column">
                                ...
                                <label class="mb-n1">Районы</label>
                                <select class="form-select mb-3" multiple name="raionsFilter[]">
                                ...
                                <label class="mb-n1">Культуры</label>
                                <select class="form-select mb-3" multiple name="culturesFilter[]">
